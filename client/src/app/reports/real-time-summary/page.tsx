...
const RealTimeSummaryPage = () => {
  ...
  // Sample metrics data - these would be populated from your actual data source
  ...
  return (
    <div className="container mx-auto p-4">
      {/* Back Button */}
      <Link href="/departments/reporting" className="flex items-center text-blue-600 hover:text-blue-800 mb-4 dark:text-blue-400 dark:hover:text-blue-300">
